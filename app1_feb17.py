...
from sqlalchemy import create_engine, Column, BigInteger, String, Float, DateTime, Boolean, Text
...
"""
    ...
    def confirm_step3(current_data, c1, c2, cert):
        ...
        if mismatches:
            ...
            updated_data,
            3,
            *update_visibility(3),  # THIS handles landing_col to step6_col automatically
            ent_name,
            org,
            activity,
            ent_type,
    ...
    next3_btn.click(confirm_step3, [user_data_state, consent1, consent2, certificate_upload], [error3, user_data_state, step_state,landing_col, step0_col, step1_col, step2_col, step3_col, step4_col, step5_col, step6_col, verification_status_display, proceed_to_step5_btn])
